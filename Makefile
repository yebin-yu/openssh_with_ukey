...
srcdir=.
top_srcdir=.
abs_top_srcdir=/home/yebinyu/Documents/openssh_with_ukey
abs_top_builddir=/home/yebinyu/Documents/openssh_with_ukey
...
STRIP_OPT=-s
TEST_SHELL=sh
BUILDDIR=/home/yebinyu/Documents/openssh_with_ukey
...
CPPFLAGS=-I. -I$(srcdir) -I/usr/local/include  -D_XOPEN_SOURCE=600 -D_BSD_SOURCE -D_DEFAULT_SOURCE -D_GNU_SOURCE -DOPENSSL_API_COMPAT=0x10100000L $(PATHS) -DHAVE_CONFIG_H
PICFLAG=-fPIC
LIBS=
CHANNELLIBS=-lcrypto  -lz
K5LIBS=
GSSLIBS=
SSHDLIBS=-lcrypt  -lpam -ldl
LIBEDIT=
LIBFIDO2=
AR=ar
AWK=gawk
...
LDFLAGS=-L. -Lopenbsd-compat/ -L/usr/local/lib  -Wl,-z,relro -Wl,-z,now -Wl,-z,noexecstack -fstack-protector-strong -pie -L$(shell pwd) -llibgm3000.1.0
